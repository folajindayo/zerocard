...
export default function WithdrawConfirmation() {
  const { amount = '0', address = '' } = useLocalSearchParams<{ amount?: string; address?: string }>();
        ...
        <View style={styles.mainContent}>
          <View style={styles.titleSection}>
             <View style={styles.iconContainer}>
               ...
               <SvgXml xml={withdrawArrowUpSvg} width={16.46} height={16.46} style={styles.overlayIconSvg} />
             </View>
...
const styles = StyleSheet.create({
  ...
  confirmButton: {
   ...
   buttonContent: { // Style for content inside the button
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
    gap: 8,
